 ...
 **
 ******************************************************************************/
define("_SnX_WEATHER_ADMENU","Preferences");
define("_SnX_WEATHER_VERSION","1.09");

define("_SnX_WEATHER_DESC","SnX (SnAKes) Module de prévisions météo tirés de Weather.com avec affichage en mode block, prévision sur 10 jours, et facilement installable.");

define( "_SnX_WEATHER_BLOCK","SnX-Weather");

define("_SnX_WEATHER_ADMENU1","Editer le menu des villes");
define("_SnX_WEATHER_ADMENU2","Editer la feuille de styles (changer les couleurs et l'aspect)");
define("_SnX_WEATHER_ADMENU3","Pr&eacute;ferrences");
define("_SnX_WEATHER_ADMENU4","Derni&egrave;re version disponible");
