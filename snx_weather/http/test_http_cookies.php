 ...
 */
	...
	$user="s"; /* Define your PHP Classes site access name here */  $user_line=__LINE__;
	$password="s"; /* Define your PHP Classes site access name here */  $password_line=__LINE__;
	$host_name="ilohamail.ntica.com";
	$uri="/index.php";
