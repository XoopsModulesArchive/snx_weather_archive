...
define("_SnX_WEATHER_DESC","SnX (SnAKes) Weather.com forecast module with block support, 10 days forecast, highly customizable and easy install.");

define( "_SnX_WEATHER_BLOCK","SnX-Weather");

define("_SnX_WEATHER_ADMENU1","Edit city menu");
define("_SnX_WEATHER_ADMENU2","Edit stylesheet (change colors and aspect)");
define("_SnX_WEATHER_ADMENU3","Preferences");
define("_SnX_WEATHER_ADMENU4","Last version available");
