...
define("_SnX_WEATHER_CITY_SEARCH","City search");
define("_SnX_WEATHER_CITY_SELECT","Choose a city");

define("_SnX_WEATHER_QMEL_FULL","Qmel 150MB email account");
define("_SnX_WEATHER_NTICA_FULL","NTICA 25MB email account");
